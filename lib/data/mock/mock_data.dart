...
class MockData {
  ...
  static List<Order> seedMyOrders(LatLng cityCenter) {
    ...
    return [
      ...
      // ── Историческое: размещённые (отменённые/просроченные — НЕ выполненные)
      Order(
        id: 'm14',
        customerId: 'me',
        categoryId: 'snow',
        title: 'Почистить кровлю от снега',
        description: 'Двухскатная, частный дом, страховку — берём с собой.',
        address: 'ул. Лесная, 31',
        location: LatLng(cityCenter.latitude + 0.019, cityCenter.longitude - 0.011),
        priceRub: 4000,
      ...
      Order(
        ...
        customerId: 'me',
        categoryId: 'cleaning',
        title: 'Вымыть окна на балконе',
        description: '3 м² остекления.',
        address: 'ул. Большая Ордынка, 28',
        location: LatLng(cityCenter.latitude - 0.004, cityCenter.longitude + 0.022),
        priceRub: 1200,
        status: OrderStatus.cancelled,
      ...
      Order(
        ...
        customerId: 'me',
        categoryId: 'repair',
        title: 'Заменить унитаз',
        description: 'Старый снять, новый поставить.',
        address: 'ул. Малая Бронная, 14',
        location: LatLng(cityCenter.latitude - 0.011, cityCenter.longitude + 0.004),
        priceRub: 2800,
        status: OrderStatus.cancelled,
